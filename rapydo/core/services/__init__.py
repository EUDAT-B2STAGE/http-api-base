...
import abc
import time
from rapydo.core.confs import CORE_PACKAGE, CUSTOM_PACKAGE
...
class ServiceFarm(metaclass=abc.ABCMeta):
    ...
    def load_base_models(cls):
        ...
        module_path = CORE_PACKAGE + '.models.' + cls.define_service_name()
    ...
    def load_custom_models(cls):
        ...
        module_path = CUSTOM_PACKAGE + '.models.' + cls.define_service_name()
